...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-0 sm:p-2", className)}
      classNames={{
        months: "flex flex-col sm:flex-row space-y-2 sm:space-x-2 sm:space-y-0",
        month: "space-y-0 sm:space-y-1",
        ...
        table: "w-full border-collapse space-y-0 sm:space-y-1",
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-8 sm:w-9 font-normal text-[0.8rem]",
        row: "flex w-full mt-0 sm:mt-1",
        ...
        day: cn(
          ...
          "h-7 w-7 sm:h-8 sm:w-8 p-0 m-0 font-normal aria-selected:opacity-100"
        ),
